...
<aside class="main-sidebar sidebar-light-navy elevation-4 sidebar-no-expand">
    ...
    <a href="index3.html" class="brand-link">
        <img src="/assets/images/logo/pulao-logo.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">BCISMS - ADMIN</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <!-- Student Management -->
                <li class="nav-item">
                    <a href="/admin/residents" class="nav-link">
                ...
                <!-- Logout -->
                <li class="nav-item">
                    <a href="/auth-api/logout" class="nav-link">
